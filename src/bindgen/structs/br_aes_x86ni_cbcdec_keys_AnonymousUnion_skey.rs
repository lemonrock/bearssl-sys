...
impl br_aes_x86ni_cbcdec_keys_AnonymousUnion_skey
{
	#[inline(always)]
	#[allow(trivial_casts)]
...
impl Clone for br_aes_x86ni_cbcdec_keys_AnonymousUnion_skey
{
	#[inline(always)]
	fn clone(&self) -> Self
	{
...
impl Default for br_aes_x86ni_cbcdec_keys_AnonymousUnion_skey
{
	#[inline(always)]
	fn default() -> Self
	{
